...
| **D15** | **Commission occasion** = 15 % (repère PangoBooks ~20 %) | 15 % | 🟡 à confirmer |
| **D16** | **Prise en charge des frais Fapshi (3 % encaissement, 0 % payout)** : `brut` (déduits du prix puis partage — auteur et plateforme partagent le coût) vs `plateforme` (absorbe seule) | `brut` | 🟡 à confirmer |
